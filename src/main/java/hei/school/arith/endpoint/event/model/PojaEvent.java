...
import static hei.school.arith.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.arith.PojaGenerated;
import hei.school.arith.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "hei.school.arith.event1";
    return "hei.school.arith.event2";
  }
}
